                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <img src="{{asset('storage/' . $product->image)}}" alt="" width="80px" height="80px">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="description">Descriptions</label>                                          
                                            <textarea placeholder="Describe Your Product..." name="description" id="" cols="30" rows="10" class="form-control @error('description') is-invalid @enderror">{{$product->description}}</textarea>                                        
                                            @error('description')
                                                <span class="invalid-feedback">
                                                    <strong>{{message}}</strong>
                                                </span>
